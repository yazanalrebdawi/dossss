        ...
        listener: (context, state) {
          if (state.checkAuthState == CheckAuthState.logoutSuccess) {
            ScaffoldMessenger.of(context).showSnackBar(customAppSnackBar(
              AppLocalizations.of(context)?.translate('logoutSuccess') ?? "Logged out successfully!", 
              context
            ));
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildOptionItem(
                            ...
                            title: AppLocalizations.of(context)?.translate('profileSettings') ?? 'Profile Settings',
                            onTap: () {
                          ...
                          _buildOptionItem(
                            ...
                            title: AppLocalizations.of(context)?.translate('changePassword') ?? 'Change Password',
                            onTap: () {
    ...
    showDialog(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            AppLocalizations.of(context)?.translate('logoutConfirmation') ?? 'Are you sure you want to logout?',
            style: AppTextStyles.s16w400,
          ),
          actions: [
            TextButton(
